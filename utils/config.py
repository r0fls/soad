...
BROKER_MAP = {
    ...
    'kraken': lambda config, engine: KrakenBroker(api_key=config['api_key'], secret_key=config['secret_key'], engine=engine, prevent_day_trading=config.get('prevent_day_trading', False))
}
